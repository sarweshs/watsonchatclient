...
import com.yuktix.watsonchat.event.PresenceEventListener;
...
public class ChatConfig {
	...
	public RestTemplate restTemplate(RestTemplateBuilder builder) {
		//return builder.basicAuthorization(chatProperties.getImUserName(), chatProperties.getImPassword()).build();
